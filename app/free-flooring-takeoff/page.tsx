...
export const metadata: Metadata = {
  title: 'Flooring Takeoff Tool NZ - Free Floor Plan Measuring | QuoteCore+ NZ',
  description:
    ...
    <div className="bg-slate-50">
      ...
      <section className="mx-auto max-w-3xl px-4 pt-10 pb-6 text-center md:pt-14">
        <h1 className="text-3xl font-semibold tracking-tight text-slate-900 md:text-4xl">
          Flooring Takeoff &amp; Estimating Tool NZ
        </h1>
      ...
      <section className="mx-auto max-w-3xl px-4 py-14">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-600">
          ...
          <Link href="https://quote-core.com/blog/how-to-measure-pdf-plans" className="text-[#BD4A1A] underline underline-offset-2">complete PDF plan measuring guide</Link>.
        </p>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-14">
        ...
        <ul className="mt-4 grid gap-3 text-sm text-slate-600">
          ...
          <li><Link href="https://quote-core.com/free-flooring-calculator" className="text-[#BD4A1A] underline underline-offset-2">Flooring Calculator</Link> — already know your dimensions</li>
