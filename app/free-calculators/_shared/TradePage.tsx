    ...
    <div className="mx-auto w-full max-w-5xl px-4 py-8 lg:px-6">
      ...
      <section className="mt-12">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <a
            href="https://quote-core.com/free-purchase-order-generator"
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full text-left p-5 bg-white border-2 border-slate-200 rounded-xl hover:border-[#FF6B35] hover:shadow-lg transition-all group"
          >
          ...
          <a
            href="https://quote-core.com/free-invoice-generator"
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full text-left p-5 bg-white border-2 border-slate-200 rounded-xl hover:border-[#FF6B35] hover:shadow-lg transition-all group"
          >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-slate-900 text-sm">Try our free tools</p>
