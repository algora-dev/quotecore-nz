...
import { useFreeToolsAuth } from '@/components/free-tools/FreeToolsAuthProvider';
          ...
          <div className="space-y-5">
            ...
            <CalcResultPopup
              ...
              ctaText={shared.popupTrigger?.stage === 'smart-to-signup'
                ? (!authUser
                    ? 'Create an account to save this component'
                    : tierInfo?.tier === 3
              ...
              ctaHref={shared.popupTrigger?.stage === 'smart-to-signup'
                ? `https://app.quote-core.com/signup?ref=${config.slug}`
                : `https://quote-core.com/free-quote-generator?qty=${encodeURIComponent(shared.popupTrigger?.qty ?? '')}&unit=${encodeURIComponent(shared.popupTrigger?.unit ?? 'm\u00b2')}&ref=${config.slug}`
              }
