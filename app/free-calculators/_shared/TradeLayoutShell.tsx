      ...
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between gap-4 px-4 py-3 lg:px-6">
          <Link href="/free-tools" prefetch={false} className="flex items-center gap-2">
            <img src="/MainQCP.png" alt="QuoteCore+" width={140} height={32} className="h-8 w-auto" />
          </Link>
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-8 lg:px-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://quote-core.com/free-quote-generator" target="_blank" rel="noopener noreferrer" className="text-xs font-medium text-slate-600 hover:text-slate-900">
                Free Quote Generator
              </a>
              <a href="https://quote-core.com/free-invoice-generator" target="_blank" rel="noopener noreferrer" className="text-xs font-medium text-slate-600 hover:text-slate-900">
