...
export const SLUGS_4: SlugDef[] = [
  ...
  },
  {
    ...
    mTitle: 'Free Roofing Material Calculator - Tile, Sheet & Shingle Quantities | QuoteCore+',
    ...
    tips: [
      ...
      ['Smart Components in QuoteCore+', 'The Smart Component Creator does what a material calculator does and more - it builds reusable roofing components with materials, waste, and costs. Try the Smart Component Creator for a more powerful workflow.'],
    ],
    formulas: [
    ...
    faqs: [
      ...
      ['Best free roofing material calculator?', 'This tool calculates tile, sheet, and shingle quantities from roof area and pitch with waste allowance. For a more powerful workflow, try the Smart Component Creator which builds reusable roofing components.'],
    ],
  },
];
