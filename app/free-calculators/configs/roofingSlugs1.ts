...
export const SLUGS_1: SlugDef[] = [
  ...
  },
  {
    slug: 'free-roof-pitch-calculator',
    defaultTab: 'pitch-rafter',
    name: 'Roof Pitch Calculator NZ',
    mTitle: 'Roof Pitch Calculator NZ — Free Degrees, Ratio & Rise/Run',
    mDesc: 'Free NZ roof pitch calculator. Convert between degrees, rise/run ratio and percentage. Includes pitch factor for roof surface area. Metric, no signup required.',
    ogTitle: 'Roof Pitch Calculator NZ — Free Degrees, Ratio & Rise/Run',
    ogDesc: 'Free NZ roof pitch calculator. Convert between degrees, rise/run and percentage.',
    h1: 'Roof Pitch Calculator NZ',
    hero: 'The QuoteCore+ free NZ roof pitch calculator converts roof pitch between degrees, rise/run ratio and percentage. Enter any one value and it converts instantly. Includes the pitch factor for turning plan area into actual roof surface area. Free, no signup.',
    tipsH: 'Roof pitch - did you know?',
    tips: [
      ['What exactly is roof pitch?', 'Roof pitch is the steepness of a roof, expressed as an angle in degrees or as a ratio of rise to run. NZ roofers commonly use degrees (e.g. 35\u00b0); the ratio form (e.g. 6:12) is more common in the US. Both describe the same thing.'],
      ['Degrees vs ratio conversion', 'To convert ratio to degrees: pitch\u00b0 = arctan(rise \u00f7 run). A 6:12 roof = arctan(0.5) = 26.57\u00b0. To convert degrees to ratio: tan(pitch\u00b0). At 35\u00b0, tan(35) = 0.700, so the ratio is ~7:10.'],
      ['Why pitch matters for materials', 'Pitch determines roof surface area. The pitch factor (1 \u00f7 cos(pitch\u00b0)) converts plan area to actual roof area. At 35\u00b0, the factor is 1.221 - 100 m\u00b2 plan becomes 122.1 m\u00b2 of roof surface.'],
      ['Minimum pitch by material', 'Common NZ minimums: long-run steel and corrugated iron typically 3\u00b0+ (profile-dependent, check the manufacturer); concrete/clay tiles generally 17.5\u00b0+; membrane flat roofs need a 1:80 fall (~0.7\u00b0). Below minimums, water ponds and penetrates.'],
    ],
    formulas: [
      ['Pitch from rise/run', 'pitch\u00b0 = arctan(rise \u00f7 run)'],
      ['Rise/run from pitch', 'ratio = tan(pitch\u00b0)'],
    ...
    faqs: [
      ['How do I calculate roof pitch in degrees?', 'Measure rise over a known run (e.g. 300mm over 1000mm) and calculate arctan(0.3) = 16.7\u00b0. Or use a digital level on the roof surface.'],
      ['What is a 6:12 pitch in degrees?', 'arctan(6/12) = 26.57\u00b0 - a common residential roof pitch in parts of the US; NZ roofs are usually specced directly in degrees.'],
      ['What pitch factor should I use?', '1 \u00f7 cos(pitch\u00b0). At 25\u00b0 = 1.103, at 35\u00b0 = 1.221, at 45\u00b0 = 1.414. Multiply plan area by this factor for actual roof surface area.'],
      ['Is this roof pitch calculator free?', 'Yes - it converts between degrees, ratios and percentages and shows the pitch factor, free with no signup. Built for NZ roofs and metric measurements.'],
    ],
  },
];
