...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Digital Roof Takeoff", item: `${site.url}/features/digital-roof-takeoff` },
  ],
};
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-zinc-950">
       <BlogHeader />
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Features", href: "/features" }, { label: "Digital Roof Takeoff NZ" }]} />
