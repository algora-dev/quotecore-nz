...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Material Ordering", item: `${site.url}/features/material-ordering` },
  ],
};
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-zinc-950">
       <BlogHeader />
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Features", href: "/features" }, { label: "Material Ordering NZ" }]} />
