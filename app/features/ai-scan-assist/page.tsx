...
export const metadata: Metadata = {
  title: "AI Scan Assist for Roof Plans NZ | QuoteCore+",
  description:
  ...
  alternates: {
    canonical: "https://www.quote-core.co.nz/features/ai-scan-assist",
  ...
  openGraph: {
    ...
    url: "https://www.quote-core.co.nz/features/ai-scan-assist",
    siteName: "QuoteCore+",
    type: "website",
  },
};
          ...
          <div className="mt-8 overflow-hidden rounded-2xl border border-zinc-200">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-zinc-100">
                ...
                <tr className="hover:bg-orange-50/40"><td className="px-5 py-3 text-sm font-medium text-zinc-900">Result</td><td className="px-5 py-3 text-sm text-zinc-700">Complete, priced roof takeoff in NZD</td><td className="px-5 py-3 text-sm text-zinc-500">Complete, priced roof takeoff in NZD</td></tr>
              </tbody>
            </table>
          </div>
        </section>
