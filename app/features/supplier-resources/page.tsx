...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Supplier Resources", item: `${site.url}/features/supplier-resources` },
  ],
};
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-zinc-950">
       <BlogHeader />
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Features", href: "/features" }, { label: "Supplier Resources NZ" }]} />
...
Import New Zealand supplier pricing and component libraries.
        ...
        <section className="mx-auto max-w-5xl px-6 pb-16 lg:px-8">
          ...
          <div className="mt-6 rounded-xl border border-slate-200 p-6">
            ...
            <ol className="mt-4 space-y-3 text-sm text-zinc-600">
              <li><strong>1. Download CSV:</strong> Download the Roofing Industries product catalogue CSV - product codes, names, and prices + GST.</li>
              <li><strong>2. Upload to converter:</strong> Open the catalog-to-component converter in QuoteCore+ and upload the CSV.</li>
              <li><strong>3. Map columns:</strong> Match CSV columns to component fields: product code to SKU, product name to component name, price to material cost.</li>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-24 lg:px-8">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-8 py-10 text-center">
            ...
            <p className="mt-2 text-zinc-600">No trial needed - test the workflow with our free tools.</p>
