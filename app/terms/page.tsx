...
const TOC = [
  ...
  { id: 'trials-and-free-access', label: '4. Promotional access' },
...
export default function TermsOfServicePage() {
  return (
    <LegalPageShell title="Terms of Service" effectiveDate="17 July 2026 (v2.0)" toc={TOC}>
      ...
      <p>
        Please read these Terms carefully. By creating an account or purchasing a subscription, accepting an invitation to a workspace, or otherwise using QuoteCore<span className="text-orange-500">+</span>, you agree to be bound by them.
      </p>
      <p>
      ...
      <h2 id="trials-and-free-access">4. Promotional access</h2>
      <p>We may offer promotional access to parts of the Service from time to time, including through our free tools.</p>
      <p>Promotional access does not automatically become a paid subscription unless you actively select a paid Plan and authorise payment.</p>
      <p>We may change or withdraw promotional access for future users. Where reasonably possible, we will allow existing promotional access to run for the period originally offered.</p>
      <p>Promotional access may have different storage, support, usage and feature limits from paid Plans.</p>
      ...
      <p>For a claim arising where no fees have been paid, our aggregate liability will not exceed USD 100.</p>
