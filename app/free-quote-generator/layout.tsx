...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Create professional quotes in minutes. NZD pricing, GST included. No signup required.',
  ...
  alternates: {
    canonical: `${SITE_URL}/free-quote-generator`,
    languages: {
      'en-NZ': `${SITE_URL}/free-quote-generator`,
      'en': 'https://quote-core.com/free-quote-generator',
      'x-default': 'https://quote-core.com/free-quote-generator',
    },
  },
};
...
const webAppLd = {
  ...
  description: 'Free online quote generator for NZ trades. Create professional quotes with line items, GST calculations, and PDF download. No signup required.',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The quote-core.co.nz free quote generator is completely free with no signup required. Create quotes, download as PDF, and send to customers. No watermark, no hidden fees.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No account is needed. You can create and download a professional quote immediately. If you want to save quotes, track approvals, or import components from QuoteCore+, you can sign up for the app.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The quote generator lets you add your business name, logo, contact details, GST rate, and terms and conditions. Your quote will look like it came from your own software.',
      },
    },
    {
      '@type': 'Question',
...
const faqs = [
  { q: 'Is the quote generator really free?', a: 'Yes. Create quotes, download as PDF, and send to customers. No watermark, no hidden fees.' },
  { q: 'Do I need to create an account?', a: 'No account is needed. Create and download a professional quote immediately. Sign up for the app if you want to save quotes, track approvals, or import components.' },
  { q: 'Can I add my logo and business details?', a: 'Yes. Add your business name, logo, contact details, GST rate, and terms. Your quote looks like it came from your own software.' },
    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 md:py-16">
        ...
        <p className="text-sm text-slate-600 leading-relaxed mb-6">
          ...
          Add line items with quantities and pricing, apply GST, include your business branding, and download as PDF.
          No signup, no email required, no watermark. Built for New Zealand trades.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <div>
            ...
            <ul className="space-y-1.5 text-sm text-slate-600">
              ...
              <li>Set GST rate and discounts</li>
