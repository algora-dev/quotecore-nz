      ...
      <section className="border-t border-slate-200 bg-slate-50 px-4 py-12">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-6 text-sm text-slate-600">
            ...
            <Link href="https://quote-core.com/blog/price-a-job-from-measurements" className={link}>how to price a job from your measurements</Link>,{' '}
            <Link href="https://quote-core.com/blog/how-to-measure-pdf-plans" className={link}>how to measure PDF plans online</Link>, or see{' '}
            <Link href="https://quote-core.com/blog/construction-estimating-spreadsheet-alternative" className={link}>why contractors move on from estimating spreadsheets</Link>. Comparing full systems? See{' '}
