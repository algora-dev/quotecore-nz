...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Create professional purchase orders in minutes. NZD pricing. No signup required.',
  ...
  alternates: {
    canonical: `${SITE_URL}/free-purchase-order-generator`,
    languages: {
      'en-NZ': `${SITE_URL}/free-purchase-order-generator`,
      'en': 'https://quote-core.com/free-purchase-order-generator',
      'x-default': 'https://quote-core.com/free-purchase-order-generator',
    },
  },
};
...
const webAppLd = {
  ...
  description: 'Free online purchase order generator for NZ trades. Create professional POs for suppliers with line items, delivery dates, and business branding. Download as PDF. No signup required.',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The quote-core.co.nz free purchase order generator is completely free with no signup required. Create POs and download as PDF. No watermark, no hidden fees.',
      },
    },
    {
      '@type': 'Question',
...
const faqs = [
  { q: 'Is the purchase order generator really free?', a: 'Yes. Create POs and download as PDF. No watermark, no hidden fees.' },
