...
export default function HomePage() {
  ...
  const primaryButton =
    "inline-flex min-h-11 items-center justify-center rounded-full bg-[#E85D2B] px-5 py-2.5 text-sm font-medium text-white transition-colors duration-200 hover:bg-[#D45A28]";
          ...
          <div className="relative mx-auto max-w-7xl px-6 pt-12 lg:px-8 lg:pt-16">
            <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-center lg:gap-10 xl:gap-12">
              ...
              <div className="relative z-20 flex-1 text-center lg:flex-[1.12] lg:text-left">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#D45A28]">Built from real New Zealand trade experience</p>
                ...
                <div key={item.number} className="contents">
                  ...
                  >
                    <div className="flex items-start gap-4">
                            ...
                            <div className="mt-5 space-y-3">
                              {item.options.map((option) => (
                                <div key={option.title} className="flex items-center gap-4 rounded-2xl border border-zinc-100 bg-white px-4 py-3 shadow-[0_8px_22px_rgba(15,23,42,0.07)]">
                                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#FF6B35]/10 text-[#D45A28]" aria-hidden="true">
                      ...
                      {i !== activeStep && (
                        <svg viewBox="0 0 24 24" className="mt-3 h-5 w-5 shrink-0 text-zinc-500 transition-transform group-hover:translate-x-1 group-hover:text-[#D45A28]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <div className="relative hidden lg:block">
              ...
              {tutorialPages.length > 1 ? (
                <button
                  ...
                  className="absolute -right-4 top-1/2 z-10 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-zinc-200 bg-white text-[#D45A28] shadow-[0_14px_40px_rgba(15,23,42,0.10)] transition-colors hover:bg-zinc-50 lg:flex"
                      ...
                      <ul className="mt-6 flex-1 space-y-2">
                        {plan.features.map((f) => (
                          <li key={f} className="flex items-center gap-2 text-sm">
                            <svg className="h-4 w-4 shrink-0 text-[#D45A28]" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="grid lg:grid-cols-[1fr_0.95fr]">
                <div className="flex flex-col justify-center px-8 py-10 sm:px-12 lg:px-20">
                  ...
                  <div className="mt-7 flex flex-col gap-4 sm:flex-row">
                    <a
                      href="/free-trial"
                      className="inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-[#E85D2B] px-9 text-base font-semibold text-white transition-colors hover:bg-[#D45A28]"
      ...
      >
        ...
        >
          <div className="flex items-start gap-2.5">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#FF6B35]/10 text-[#D45A28]">
      ...
      {[0, 1, 2, 3, 4].map((index) => {
        ...
        return (
          <span key={index} className="relative h-4 w-4 text-zinc-200" aria-hidden="true">
            ...
            <span className="absolute inset-0 overflow-hidden text-[#D45A28]" style={{width: `${fillPercent}%`}}>
