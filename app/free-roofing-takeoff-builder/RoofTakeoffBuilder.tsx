...
export function RoofTakeoffBuilder({ embed = false }: { embed?: boolean }) {
  ...
  const [currency, setCurrency] = useState(CURRENCY_OPTIONS[4]); // NZD default for NZ site
  ...
  useEffect(() => {
    const timeoutId = window.setTimeout(() => {
      ...
      if (saved) {
        ...
        if (data.currencyCode) setCurrency(CURRENCY_OPTIONS.find(c => c.code === data.currencyCode) || CURRENCY_OPTIONS[4]);
        if (data.sections) {
  ...
  const clearTakeoff = () => {
    ...
    setMasterPitch('25');
    setMasterRatio('5:12');
    setCurrency(CURRENCY_OPTIONS[4]);
        ...
        <section className="border-t border-slate-200 bg-slate-50">
          <div className="mx-auto max-w-5xl px-4 md:px-6 py-10 md:py-14">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Roofing Calculator */}
              <a href={`${COM_URL}/free-roofing-calculator`} target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-slate-200 bg-white p-5 hover:border-[#FF6B35] hover:shadow-[0_0_8px_rgba(255,107,53,0.08)] hover:bg-orange-50/40 transition-all group">
                <div className="flex items-start justify-between mb-3">
              ...
              <a href={`${COM_URL}/free-construction-calculator`} target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-slate-200 bg-white p-5 hover:border-[#FF6B35] hover:shadow-[0_0_8px_rgba(255,107,53,0.08)] hover:bg-orange-50/40 transition-all group">
                <div className="flex items-start justify-between mb-3">
                  <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center group-hover:bg-orange-100 transition-colors">
              ...
              {/* Quote Generator */}
              <a href={`${COM_URL}/free-quote-generator`} target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-slate-200 bg-white p-5 hover:border-[#FF6B35] hover:shadow-[0_0_8px_rgba(255,107,53,0.08)] hover:bg-orange-50/40 transition-all group">
                <div className="flex items-start justify-between mb-3">
                  <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center group-hover:bg-orange-100 transition-colors">
              ...
              <a href={`${COM_URL}/free-purchase-order-generator`} target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-slate-200 bg-white p-5 hover:border-[#FF6B35] hover:shadow-[0_0_8px_rgba(255,107,53,0.08)] hover:bg-orange-50/40 transition-all group">
                <div className="flex items-start justify-between mb-3">
                  <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center group-hover:bg-orange-100 transition-colors">
              ...
              {/* Invoice Generator */}
              <a href={`${COM_URL}/free-invoice-generator`} target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-slate-200 bg-white p-5 hover:border-[#FF6B35] hover:shadow-[0_0_8px_rgba(255,107,53,0.08)] hover:bg-orange-50/40 transition-all group">
                <div className="flex items-start justify-between mb-3">
                  <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center group-hover:bg-orange-100 transition-colors">
