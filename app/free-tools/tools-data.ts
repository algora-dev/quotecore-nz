...
export const TOOLS: ToolEntry[] = [
  ...
  { slug: 'free-roofing-calculator', name: 'Roofing Calculator', industry: 'Roofing', description: 'Roof pitch, rafter and hip/valley lengths, surface area, and roofing material quantities.', keywords: ['pitch', 'rafter', 'hip', 'valley', 'area', 'battens', 'angle'], isCore: true, category: 'calculator', ported: true },
  { slug: 'free-construction-calculator', name: 'Construction Calculator', industry: 'Construction', description: 'Floor and wall areas, timber and stud lengths, material quantities, and cutting angles.', keywords: ['area', 'timber', 'stud', 'materials', 'angle', 'wall', 'floor'], isCore: true, category: 'calculator', ported: true },
  { slug: 'free-concrete-calculator', name: 'Concrete Calculator', industry: 'Concrete', description: 'Slab and footing volumes with depth presets, formwork areas, falls, and ready-mix pricing.', keywords: ['slab', 'footing', 'volume', 'formwork', 'falls', 'gradient', 'ready-mix'], isCore: true, category: 'calculator', ported: true },
  { slug: 'free-landscaping-calculator', name: 'Landscaping Calculator', industry: 'Landscaping', description: 'Garden and lawn areas, turf and topsoil quantities, slopes, gradients, and falls.', keywords: ['garden', 'lawn', 'turf', 'topsoil', 'slope', 'gradient', 'area'], isCore: true, category: 'calculator', ported: true },
  { slug: 'free-birds-mouth-calculator', name: "Bird's Mouth Calculator", industry: 'Roofing', description: "Bird's mouth seat cut and plumb cut angles, heel height, and notch depth with 1/3-depth pass/fail check.", keywords: ['birdsmouth', 'seat cut', 'plumb cut', 'rafter', 'stringer', 'stair', 'notch'], isCore: true, category: 'calculator', ported: true },
  { slug: 'free-quote-generator', name: 'Quote Generator', industry: 'Trade', description: 'Create professional quotes in minutes. No signup required, download as PDF.', keywords: ['quote', 'estimate', 'pdf', 'free'], isCore: true, category: 'generator', ported: true },
  { slug: 'free-invoice-generator', name: 'Invoice Generator', industry: 'Trade', description: 'Create professional invoices with GST calculations. Download as PDF.', keywords: ['invoice', 'billing', 'pdf', 'free', 'gst'], isCore: true, category: 'generator', ported: true },
  { slug: 'free-purchase-order-generator', name: 'Purchase Order Generator', industry: 'Trade', description: 'Generate professional purchase orders for suppliers. Download as PDF.', keywords: ['purchase order', 'po', 'supplier', 'pdf', 'free'], isCore: true, category: 'generator', ported: true },
