  ...
  return (
    <div className="mt-6 flex justify-center">
      <Link
        ...
        className="inline-flex items-center gap-1.5 rounded-full bg-black px-7 py-3.5 text-sm font-semibold text-white transition-all hover:bg-slate-800 hover:shadow-[0_0_16px_rgba(255,107,53,0.5)] ring-2 ring-transparent hover:ring-orange-400/30 min-h-[44px]"
      >
        {label}
    ...
    <section id="quote-generator" className="scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-6 md:gap-10 items-center">
        <div className="order-2 lg:order-1">
          <p className="text-xs md:text-sm text-slate-500 leading-relaxed">Create professional quotes in minutes with GST 15% defaults. Optional signup, no catch. Download as PDF and send to your customer today.</p>
          <ul className="mt-4 md:mt-5 space-y-3">
            ...
            <li className="flex items-start gap-2.5"><svg className="w-5 h-5 text-[#BD4A1A] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span className="text-sm text-slate-600 leading-relaxed">Add your logo, business details, GST rate and terms - looks like it came from your own software</span></li>
  ...
  return (
    <section id="roof-takeoff-builder" className="scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-6 md:gap-10 items-center">
        ...
        <div className="order-1 lg:order-2">
          <p className="text-xs md:text-sm text-slate-500 leading-relaxed">Build a complete roof takeoff manually. Input all your lengths and areas, apply pitch calculations, and get a full material report. Designed for NZ long-run, corrugated, and tile roofs.</p>
          <ul className="mt-4 md:mt-5 space-y-3">
  ...
  return (
    <section id="calculators" className="scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-6 md:gap-10 items-center">
        ...
        <div className="order-1 lg:order-2">
          <p className="text-xs md:text-sm text-slate-500 leading-relaxed">Calculate areas, volumes, complex roofing angles, material quantities and more. Built for the field - mobile-friendly and fast. NZ-specific measurements, materials, and NZD pricing.</p>
          <ul className="mt-4 md:mt-5 space-y-3">
...
export function PurchaseOrderSection() {
  return (
    <section id="purchase-order" className="scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-6 md:gap-10 items-center">
        <div className="order-2 lg:order-1">
          <p className="text-xs md:text-sm text-slate-500 leading-relaxed">Generate professional purchase orders for your NZ suppliers in minutes. No signup, download as PDF.</p>
          <ul className="mt-4 md:mt-5 space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-6 md:gap-10 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <ul className="mt-4 md:mt-5 space-y-3">
            ...
            <li className="flex items-start gap-2.5"><svg className="w-5 h-5 text-[#BD4A1A] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span className="text-sm text-slate-600 leading-relaxed">Add your branding, payment terms and NZ bank account details</span></li>
            <li className="flex items-start gap-2.5"><svg className="w-5 h-5 text-[#BD4A1A] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span className="text-sm text-slate-600 leading-relaxed">Pre-fill from a URL parameter - generate an invoice from your free quote instantly</span></li>
