      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 animate-[fadeInUp_0.3s_ease-out]">
        ...
        <div className="text-center mb-5">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-orange-50 border border-orange-100 px-3 py-1 mb-3">
            <svg className="w-3.5 h-3.5 text-[#BD4A1A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
            </svg>
            <span className="text-xs font-medium text-[#BD4A1A]">Your {toolType} is ready</span>
          </div>
        ...
        <div className="space-y-2.5">
          ...
          <TooltipButton
            label="Save to App"
            tooltip="Create a QuoteCore+ account. Save, edit, send quotes and use all features of the app"
            onClick={onSaveToApp}
            variant="accent"
            icon={saveIcon}
          />
