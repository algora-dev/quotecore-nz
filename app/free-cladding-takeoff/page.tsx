...
const SITE_URL = 'https://quote-core.co.nz';

export const metadata: Metadata = {
  title: 'Cladding Takeoff Tool NZ — Measure Elevation Plans | QuoteCore Plus',
  description:
    ...
    <div className="bg-slate-50">
      ...
      <section className="mx-auto max-w-3xl px-4 py-14">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-600">
          ...
          <Link href="https://quote-core.com/blog/how-to-measure-walls-cladding-from-plans" className="text-[#BD4A1A] underline underline-offset-2">complete wall &amp; cladding takeoff guide</Link>.
        </p>
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-600">
          ...
          <Link href="https://quote-core.com/blog/how-to-do-cladding-takeoff" className="text-[#BD4A1A] underline underline-offset-2">cladding takeoff guide</Link>{' '}
      ...
      <section className="mx-auto max-w-3xl px-4 pb-14">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-600">
          ...
          have areas? Use the{' '}
          <Link href="https://quote-core.com/free-wall-area-calculator" className="text-[#BD4A1A] underline underline-offset-2">free wall area calculator</Link>{' '}
          or{' '}
          <Link href="https://quote-core.com/free-paint-calculator" className="text-[#BD4A1A] underline underline-offset-2">free paint calculator</Link>{' '}
          instead.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-14">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-600">
          ...
          <Link href="https://quote-core.com/blog/how-to-measure-a-roof-from-a-pdf-plan" className="text-[#BD4A1A] underline underline-offset-2">how to measure a roof from a plan</Link>.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-14">
        ...
        <ul className="mt-4 grid gap-3 text-sm text-slate-600">
          ...
          <li><Link href="https://quote-core.com/free-wall-area-calculator" className="text-[#BD4A1A] underline underline-offset-2">Wall Area Calculator</Link> — already know your dimensions</li>
          <li><Link href="https://quote-core.com/free-paint-calculator" className="text-[#BD4A1A] underline underline-offset-2">Paint Calculator</Link> — paint quantities from wall areas</li>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-14">
        ...
        <ul className="mt-4 grid gap-3 text-sm text-slate-600">
          <li><Link href="https://quote-core.com/blog/how-to-measure-walls-cladding-from-plans" className="text-[#BD4A1A] underline underline-offset-2">How to measure walls &amp; cladding from plans</Link> — the full takeoff guide</li>
          <li><Link href="https://quote-core.com/blog/how-to-measure-pdf-plans" className="text-[#BD4A1A] underline underline-offset-2">How to measure anything from PDF plans</Link> — areas, lengths and quantities</li>
          <li><Link href="https://quote-core.com/blog/how-to-do-cladding-takeoff" className="text-[#BD4A1A] underline underline-offset-2">How to do a cladding takeoff</Link> — areas, openings and quantities</li>
        </ul>
      </section>
