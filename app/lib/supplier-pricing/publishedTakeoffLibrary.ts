 ...
 * Ported from quotecore-plus for NZ site supplier integration.
 */

import { createClient } from '@supabase/supabase-js';
import type { RoofComponentDef } from '../../free-roofing-takeoff-builder/types';
import { BUILT_IN_ORDER } from '../../free-roofing-takeoff-builder/calc';
...
export interface PublishedTakeoffLibrary {
  ...
  slotOptions: Record<string, PublishedTakeoffComponent[]>;
}
