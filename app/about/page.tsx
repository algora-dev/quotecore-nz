      ...
      <main className="min-h-screen bg-white text-zinc-950">
        ...
        <section className="relative overflow-hidden pb-12 pt-16">
          ...
          <div className="relative mx-auto max-w-3xl px-6 lg:px-8">
            ...
            <h1 className="mt-3 text-4xl font-semibold tracking-tight sm:text-5xl">
              Shaun lived the quoting problem. The QuoteCore+ team built the solution.
            </h1>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-3xl px-6 pb-24 lg:px-8">
          ...
          <div className="flex items-center gap-6 rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm">
            <img src="/shaun.jpg" alt="Shaun, founder and construction lead of QuoteCore+" className="h-20 w-20 rounded-full object-cover border-2 border-[#FF6B35]/20" />
            <div>
              <p className="text-xl font-semibold">Shaun</p>
              <p className="text-sm text-zinc-500">Founder and construction lead, QuoteCore+</p>
          ...
          <div className="mt-12">
            ...
            <div className="relative pl-12">
              ...
              <div className="pb-14">
                ...
                <div className="mt-4 space-y-4 leading-8 text-zinc-600">
                  ...
                  <p>Nothing was built around the way working trades actually move from measurement to quote to job. Shaun wanted something that understood the workflow properly: measurements, materials, labour, approvals, job details, invoicing, and payment.</p>
                  <p className="font-medium text-zinc-800">That platform didn&apos;t exist. So Shaun founded QuoteCore+, and the QuoteCore+ team built it around that real workflow.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-12">
              ...
              <div className="pb-6">
                ...
                <div className="mt-4 space-y-4 leading-8 text-zinc-600">
                  <p>QuoteCore+ is founder-led and team-built. Shaun brought the lived construction experience; the QuoteCore+ team turned that direction into a serious quoting and job workflow platform.</p>
                  <p>Before launch, it was tested and refined with working trades across the industry - contractors who quoted real jobs through the platform and gave honest feedback on what wasn&apos;t good enough. Every iteration was shaped by people who actually use it on the job.</p>
                  <p className="font-medium text-zinc-800">The result is software shaped by real trade experience and built properly by a product and development team.</p>
