...
const personSchema = {
  ...
  url: "https://www.quote-core.co.nz/about",
  image: "https://www.quote-core.co.nz/shaun.jpg",
  worksFor: {
    "@type": "Organization",
    name: "QuoteCore+",
...
const breadcrumbSchema = {
  ...
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: "https://www.quote-core.co.nz/" },
    { "@type": "ListItem", position: 2, name: "About", item: "https://www.quote-core.co.nz/about" },
  ],
};
       ...
       <BlogHeader />
        ...
        <section className="mx-auto max-w-3xl px-6 pb-24 lg:px-8">
          ...
          <div className="mt-10 rounded-[2rem] border border-[#FF6B35]/20 bg-[#FF6B35]/5 p-8 text-center">
            ...
            <p className="mt-2 text-zinc-500">Test the workflow with our free tools first - no signup. Plans from $29/month.</p>
            <a
              href="/free-tools"
