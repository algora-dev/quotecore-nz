...
export const metadata: Metadata = {
  title: "Roofing Supplier Network NZ | QuoteCore+",
  description:
    "Get your roofing materials in front of Kiwi contractors who quote, order, and buy every day. Join the QuoteCore+ supplier network to reach active buyers across New Zealand.",
  alternates: {
    canonical: "https://www.quote-core.co.nz/suppliers",
    languages: hreflangLanguages("/suppliers"),
  },
  openGraph: {
    title: "Roofing Supplier Network NZ | QuoteCore+",
    description:
      "Get your roofing materials in front of Kiwi contractors who quote, order, and buy every day. Join the QuoteCore+ supplier network.",
    url: "https://www.quote-core.co.nz/suppliers",
    type: "website",
  },
};
...
const supplierBenefits = [
  ...
  },
  {
    ...
    body: "Contractors search for suppliers by region and material type across New Zealand. If you cover an area - Auckland, Wellington, Christchurch, regional NZ - you show up. No more being overlooked because someone found a competitor first.",
  },
  {
...
const howItWorks = [
  {
    ...
    body: "Share your coverage area, material categories, and contact details so we can match you with the right Kiwi contractors.",
  },
  {
    step: "02",
    title: "Upload your catalogue",
...
const faqs = [
  {
    ...
    a: "Any supplier of roofing materials - concrete or clay tiles, long-run metal, membranes, insulation, battens, fixings, flashings, spouting, downpipes, rooflights, or accessories. If Kiwi contractors buy it for roofs, it belongs here.",
  },
  {
  ...
  {
    q: "What if I only supply a specific region of New Zealand?",
    a: "That is exactly what the region-based search is for. Contractors filter suppliers by region, so you only appear in searches where you can actually deliver. Local suppliers are prioritised.",
  },
  {
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "QuoteCore+ Supplier Network NZ",
  description:
    "Get your roofing materials in front of Kiwi contractors who quote, order, and buy every day. Join the QuoteCore+ supplier network to reach active buyers across New Zealand.",
  provider: {
    "@type": "Organization",
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-zinc-950">
        ...
        <section className="relative overflow-hidden pb-16 pt-12">
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
              Get your materials in front of every Kiwi contractor who quotes online.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-zinc-600 sm:text-xl">
              QuoteCore+ connects roofing suppliers with contractors across New Zealand who are actively quoting, ordering, and buying materials every day. No directory listing. No middleman. Just your products in the workflow where purchasing decisions happen.
            </p>
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <a
                href="/contact"
                className="inline-flex items-center gap-1.5 rounded-full bg-[#FF6B35] px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#E55A28]"
              >
                Get in touch
              </a>
              <a
        ...
        {/* What suppliers need in catalogue */}
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 lg:p-12">
              ...
              <ul className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                {[
                  ...
                  "Material categories (tiles, long-run, membranes, etc.)",
          ...
          <div className="mx-auto max-w-3xl px-6 lg:px-8">
            ...
            <div className="mt-8 space-y-4">
              <div className="rounded-xl border border-slate-200 p-6">
                ...
                <p className="mt-2 text-sm text-zinc-600">Supplier catalogues are snapshots at upload time. Prices do not auto-update. Suppliers can re-upload when pricing changes.</p>
              </div>
              <div className="rounded-xl border border-slate-200 p-6">
              ...
              <div className="rounded-xl border border-slate-200 p-6">
                ...
                <p className="mt-2 text-sm text-zinc-600">Multiple suppliers in the same region can publish catalogues. Contractors choose based on pricing and availability, not paid placement.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-3xl px-6 lg:px-8">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <a href="/features/supplier-resources" className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-orange-200 hover:bg-orange-50/40">
                ...
                <p className="mt-1 text-sm text-zinc-600">How contractors import and use supplier catalogues in QuoteCore+.</p>
              </a>
              ...
              <a href="/pricing" className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-orange-200 hover:bg-orange-50/40">
                ...
                <p className="mt-1 text-sm text-zinc-600">Plans for contractors who use supplier catalogues.</p>
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="bg-zinc-950 py-16 lg:py-20">
          <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
            <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Ready to grow your roofing supply business in New Zealand?
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-lg text-zinc-400">
              If you supply quality roofing materials to Kiwi contractors, and you want to grow, we want to work with you.
            </p>
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <a
                href="/contact"
                className="inline-flex items-center gap-1.5 rounded-full bg-[#FF6B35] px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#E55A28]"
              >
                Get in touch
              </a>
              <a
