...
export const homepageFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "QuoteCore+ focuses on roofing and was built to become the best roof measuring and quoting app on the market. The core of its measuring engine comes from metal long run roofing, traditionally the most complex type of roof to measure and quote for because most sheets and flashings are all cut and bent to exact lengths for all different pitch types. This complexity allows the system to handle all other roofing systems like shingles, tiles, slate, membrane with ease since a lot of those roofing materials are generic and ordered in rolls, pallets, boxes that can suit most roofs without needing to be custom ordered.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Its possible with our app, but we suggest always checking and editing anything that our AI assist tools build for you, no system on the planet should be 100% trusted to automate quoting, unless it is 100% accurate. We've built multiple tools and features with different uses that you can use to make your quoting journey as frictionless as possible, leading to faster, more accurate, more efficient quoting, no matter your industry.",
  },
  {
