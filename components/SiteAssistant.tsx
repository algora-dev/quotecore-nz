...
function getAnswer(rawMessage: string, docsBaseUrl: string): ChatMessage {
  ...
  if (/(smart component|smart components)/.test(message)) {
    return {
      ...
      links: [
        { label: "Try the Smart Component Creator (free)", href: "https://quote-core.com/free-smart-component-creator" },
        trialCTA,
      ],
    };
  }
  ...
  if (/(invoice gen|create.*invoice|make.*invoice|billing)/.test(message)) {
    return {
      ...
      links: [
        { label: "Try the Invoice Generator", href: "https://quote-core.com/free-invoice-generator" },
        freeToolsCTA,
      ],
    };
  }
  ...
  if (/(purchase order|po gen|create.*po|material order|order.*supplier)/.test(message)) {
    return {
      ...
      links: [
        { label: "Try the PO Generator", href: "https://quote-core.com/free-purchase-order-generator" },
        freeToolsCTA,
      ],
    };
  }
  ...
  if (/(material calc|tile calc|shingle calc|how many tile|how many sheet|material.*quantit)/.test(message)) {
    return {
      ...
      links: [
        { label: "Try the Smart Component Creator", href: "https://quote-core.com/free-smart-component-creator" },
        freeToolsCTA,
      ],
    };
  }
